...
import { checkEquality as checkAccountEquality } from '../../state_account/test/util'
    ...
    for (const [k, v] of Object.entries(expected)) {
      if (Object.prototype.hasOwnProperty.call(got, k)) {
        ...
        if (Array.isArray(v)) {
          ...
          if (isAccount(actualVal)) {
            checkAccountEquality(v, actualVal)
          } else {
            throw new TypeError(`ley ${k} expected to be of type Account
