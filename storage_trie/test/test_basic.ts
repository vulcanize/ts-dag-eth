...
const stateContractLeafNodeFileName = 'state_contract_leaf_node_rlp'
const stateEOALeafNodeFileName = 'state_eoa_leaf_node_rlp'
const txLeafNodeFileName = 'tx_leaf_node_rlp'
const rctLeafNodeFileName = 'rct_leaf_node_rlp'
const logLeafNodeFileName = 'log_leaf_node_rlp'
const branchNodeFileName = 'branch_node_rlp'
const branchNodeWithEmbeddedStorageLafAndValueFileName = 'branch_node_with_embedded_storage_leaf_and_value_rlp'
const branchNodeWithEmbeddedLogLeafAndValueFileName = 'branch_node_with_embedded_log_leaf_and_value_rlp'
const branchNodeWithEmbeddedTxValueFileName = 'branch_node_with_embedded_tx_value_rlp'
const branchNodeWithEmbeddedRctValueFileName = 'branch_node_with_embedded_rct_value_rlp'
...
describe('eth-trie', function () {
  ...
  const expectedExtension = unpackTwoMemberNode(code, extensionNodeBuffer)
  ...
  const expectedLeaf = unpackTwoMemberNode(code, leafNodeBuffer)
  ...
  const expectedBranchNode = unpackBranchNode(code, branchNodeBuffer)
