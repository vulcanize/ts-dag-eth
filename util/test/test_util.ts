...
const mockHeaderHash = Buffer.from(hexToBytes('0xe8ca03102d5d8be0f2024797897194e3c607711e5b32fa5840a341207035331d'))
const mockTxCID = CID.parse('bagjqcgza5hpu6wcef46fw2nlom6aiqorhrqjikmanssb4oauzktgumklsyja')
const mockTxHash = Buffer.from(hexToBytes('0xe9df4f58442f3c5b69ab733c0441d13c609429806ca41e3814caa66a314b9612'))
